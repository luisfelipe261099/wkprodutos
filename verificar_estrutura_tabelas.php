...
echo "<h2>?? Verifica��o da Estrutura das Tabelas</h2>";
...
try {
    ...
    if ($result) {
        ...
        if (in_array('data_orcamento', $colunas)) {
            ...
            $errors[] = "? Tabela orcamentos n�o tem a coluna 'data_orcamento'";
        }
    ...
    if ($result && $result->num_rows > 0) {
        ...
        if ($result) {
            ...
            // Verificar campos de integra��o
            if (in_array('venda_id', $colunas)) {
                $success[] = "? Tabela marketplace_pedidos tem campo 'venda_id' para integra��o";
            } else {
                $errors[] = "? Tabela marketplace_pedidos n�o tem campo 'venda_id' - execute atualizar_marketplace.php";
            }
            
            if (in_array('transacao_financeira_id', $colunas)) {
                $success[] = "? Tabela marketplace_pedidos tem campo 'transacao_financeira_id' para integra��o";
            } else {
                $errors[] = "? Tabela marketplace_pedidos n�o tem campo 'transacao_financeira_id' - execute atualizar_marketplace.php";
            }
        ...
        $errors[] = "? Tabela marketplace_pedidos n�o existe - execute atualizar_marketplace.php";
    }
    ...
    if ($result) {
        ...
        foreach ($campos_marketplace as $campo) {
            if (in_array($campo, $colunas)) {
                ...
                $errors[] = "? Tabela produtos n�o tem campo '$campo' - execute atualizar_marketplace.php";
            }
        }
    ...
    foreach ($tabelas_importantes as $tabela => $campos_obrigatorios) {
        ...
        if ($result) {
            ...
            if (empty($campos_faltando)) {
                $success[] = "? Tabela '$tabela' tem todos os campos obrigat�rios";
            } else {
                $errors[] = "? Tabela '$tabela' est� faltando campos: " . implode(', ', $campos_faltando);
            }
        } else {
            $errors[] = "? Tabela '$tabela' n�o existe ou erro ao verificar: " . $conn->error;
        }
    }
...
// Exibir resultados
echo "<h3>?? Resultados da Verifica��o:</h3>";
...
echo "<hr>";
echo "<h4>?? Links �teis:</h4>";
echo "<p><a href='atualizar_marketplace.php' class='btn btn-warning'>?? Atualizar Marketplace</a></p>";
echo "<p><a href='teste_menu.php' class='btn btn-info'>?? Testar Menu</a></p>";
echo "<p><a href='criar_orcamento.php' class='btn btn-success'>?? Testar Criar Or�amento</a></p>";
